...
from backend.retrieval import retrieve, call_ollama
import traceback
...
async def chat(request: Request):
    try:
        ...
        Note: To ensure my all answer stays on ground truth, I’ve set the similarity search threshold to 0.8.
        """.lstrip()
                )
            }
        ...
        print("Backend error:", tb)
        return {"answer": f"An error occurred: {tb}"}
